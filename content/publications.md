...
## Publications:
Some of the recent peer-reviewed papers are listed below. [Google Scholar](https://scholar.google.com/citations?user=BtN6CZgAAAAJ&hl=en) or [ORCID](https://orcid.org/my-orcid?orcid=0000-0001-9297-0415) may have a more comprehensive list. See also the [Parallel Systems Lab publications](https://psl-ntu.github.io/publications).
